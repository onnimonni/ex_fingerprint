defmodule Mix.Tasks.ExFingerprint.CaptureTlsClienthello do
  use Mix.Task
  ...
  def run(args) do
    ...
    case ExFingerprint.Capture.ClientHello.capture(capture_opts) do
      {:ok, capture} ->
  ...
  defp write_capture(capture, nil) do
    ...
    root = Application.app_dir(:ex_fingerprint, "priv/captures")
    File.mkdir_p!(root)
