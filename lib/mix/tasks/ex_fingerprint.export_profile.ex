defmodule Mix.Tasks.ExFingerprint.ExportProfile do
  use Mix.Task
  ...
  def run(args) do
    ...
    case args do
      ...
      _ ->
        Mix.raise("usage: mix ex_fingerprint.export_profile PROFILE_ID [OUTPUT_PATH]")
    end
  end
  ...
  defp export(profile_id, nil) do
    profile =
      profile_id
      |> String.to_atom()
      |> ExFingerprint.Profile.resolve()
      |> ExFingerprint.Profile.to_transport_map()
