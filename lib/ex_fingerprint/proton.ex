defmodule ExFingerprint.Proton do
  @moduledoc """
  Proton VPN helpers for WireGuard configs and endpoint selection.
  """

  alias ExFingerprint.WireGuard.Config

  @default_snapshot_path "/Users/onnimonni/Projects/tls-fingerprinting-proxy/internal/proton/snapshot.json"
