defmodule ExFingerprint do
  ...
  alias ExFingerprint.BrowserProfile
  alias ExFingerprint.CookieJar
  alias ExFingerprint.Proton
  alias ExFingerprint.Solver
  alias ExFingerprint.Request
  alias ExFingerprint.Response
  alias ExFingerprint.Transport
  alias ExFingerprint.WireGuard
  ...
  def latest_profile do
    ExFingerprint.Profile.chrome_latest()
  end
